...
data_cfg = dict(
    ...
    train = dict(
        ...
        pretrained_weights = 'datas/resnet18_8xb32_in1k_20210831-fbbb1da6.pth',   #预训练权重
        freeze_flag = False,
        freeze_layers = ('backbone',),
        epoches = 100,     #训练轮数
    ),
    test=dict(
        ckpt = 'logs/ResNet/2024-11-17-14-46-29/Val_Epoch057-Acc87.500.pth',   #评估权重（训练中表现最好的）
